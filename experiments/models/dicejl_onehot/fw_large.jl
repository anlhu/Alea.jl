...
function fun()
    ...
    c = @alea begin 
        ...
        for edge in edge_list
            ...
            edges[(edge[1]+1, edge[2]+1)] = uniform(DistUIntOH{193}, 1, 2*diff+1) 
        end 


        distance = [[DistUIntOH{193}(MAX) for j in 1:num_nodes] for i in 1:num_nodes]
